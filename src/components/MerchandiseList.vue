<template>
    <scroll-view class="merchandise-wrapper" :scroll-y="true" @scrolltolower="scrolltolower"
        ...
        <div class="merchandise-item clearfix bgff" v-for="(item, index) in list" :key="index">
            ...
            <div class="merchandise-item-right fr">
                ...
                <div class="cartcontrol-warpper">
                    <cart-control :batch="batch" :cartModel="cartModel" @addCart="addCart" @reduceCart="reduceCart"
                                  :merchandiseId="item.merchandiseId" :shopId="item.shopId"></cart-control>
                </div>
            </div>
        </div>
    </scroll-view>
...
<script>
    ...
    export default {
        ...
        watch: {
            list () {
                console.log(this.list, '-------- watch merchandises -----');
            }
        },
        computed: {
