<!--suppress ALL -->
<template>
    <scroll-view class="foods-wrapper" :style="{height: screenHeight + 'rpx'}" :scroll-y="true" @scrolltolower="scrolltolower">
        <div class="order_info" v-for="(items,index) in orders" :key="index">
            ...
            <div class="order_info_nowstatus">
                <ul>
                    <li>{{items.status}}</li>
                    <li>{{items.sellPoint}}</li>
                    <li>{{items.code}}</li>
                    <li>{{items.totalAmount}}</li>
                    <li>{{items.paymentAmount}}</li>
                </ul>
            </div>
