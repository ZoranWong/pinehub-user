<template>
  <div id="location">
    ...
    <div id="location_map">
      ...
      <div id="send_time_select" v-if="show">
        <div class="top-part">
          <div class="select_li">
            <span class="select_li_title">自提点</span>
            <div class="input">{{ storeAddress }}</div>
          </div>
          <div class="select_li">
            <span class="select_li_title">营业时间</span>
            <div class="input">{{ sendAt }}</div>
          </div>
        </div>
