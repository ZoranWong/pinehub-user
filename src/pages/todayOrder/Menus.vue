  ...
  <div class="menu-wrapper">
    <div id="tab_select">
      <ul>
        ...
        <li v-for = "(tab, index) in storeCategories" :class = "{tab_select_now : cur == index}" :key = "index" @click = "tabSelect(tab.id, index)">
...
<script>
  ...
  export default {
    ...
    computed : {
      storeCategories() {
        return this.$store.getters['model.storeCategories/storeCategories'];
      }
    },
    methods : {
      tabSelect (id, index ) {
