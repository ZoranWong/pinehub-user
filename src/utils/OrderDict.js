...
export {CANCEL, WAIT, MAKE_SURE, PAID, SEND, COMPLETED, PAY_FAILED, ORDER_NUMBER_PREFIX, UNKOWN_PAY, ALI_PAY,
  WECHAT_PAY, NOT_NEED_PICK_UP_METHOD, SEND_ORDER_TO_USER, USER_SELF_PICK_UP, OFF_LINE_PAYMENT_ORDER,
  SHOPPING_MALL_ORDER, SITE_USER_ORDER, SHOP_PURCHASE_ORDER};
